...
int main()
{
	...
	//resizeWindow("【<0>原图窗口】", 400, 200);
	imshow("【<0>原图窗口】", g_srcImage);


	//方框滤波
	namedWindow("【<1>方框滤波】", 1);
	//resizeWindow("【<1>方框滤波】", 400, 200);
	//创建轨迹条
